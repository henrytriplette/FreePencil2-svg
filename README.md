...
**「描いた範囲」を勧めます。** 余白が読めるだけでなく、結合の許容量(mm)が
絵に対して素直に効きます。絵が紙の中で小さいと、無関係な端点まで許容内に
入って本数だけが減ります（実測: カメラ合わせで 162×125mm・3286本、描いた
範囲で 246×190mm・3802本。後者のほうが結合が正直に効いている）。
